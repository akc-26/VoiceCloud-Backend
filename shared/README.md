# VoiceCloud Shared Platform (@shared)

The VoiceCloud Shared Platform provides common domain contracts, data transfer definitions, enums, permission rules, validation helpers, utility functions, configuration defaults, and design tokens used across the VoiceCloud ecosystem.
...
```typescript
import { UserRole, hasPermission, Permission, ApiResponse, THEME_TOKENS } from '@shared';
