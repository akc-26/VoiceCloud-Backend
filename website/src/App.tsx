    ...
    >
      ...
      >
        ...
        <h1 style={{ fontSize: '2rem', fontWeight: 700, marginBottom: '0.75rem' }}>
          {APP_NAMES.LANDING_WEBSITE}
        </h1>
        <p style={{ color: '#64748b', lineHeight: 1.6, marginBottom: '1.5rem' }}>
          The enterprise public platform foundation is live. Multi-application hosting infrastructure prepared for VC-PH05.
        </p>
        <div
          style={{
            padding: '1rem',
        ...
        >
          Hosted at <code>/</code> | Powered by VoiceCloud Enterprise Platform Architecture
        </div>
      </div>
    </div>
  );
