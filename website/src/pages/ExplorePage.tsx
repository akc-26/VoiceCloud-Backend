...
export function ExplorePage(){
  ...
  const people=useQuery({queryKey:['ph03','discover','people'],queryFn:()=>discoveryApi.suggestedUsers(8)});
  const visiblePeople=useMemo(()=>visibleConsumerUsers(people.data?.items,currentUser).slice(0,4),[people.data?.items,currentUser?.id,currentUser?.username]);
