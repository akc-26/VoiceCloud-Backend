...
export const getCreatorTheme = (mode: 'light' | 'dark') => {
  ...
  const themeOptions: ThemeOptions = {
    palette: {
      mode,
      primary: {
        main: BRAND_CONFIG.colors.creator.primary,
        light: BRAND_CONFIG.colors.creator.primaryLight,
        dark: BRAND_CONFIG.colors.creator.primaryDark,
        contrastText: '#ffffff',
      },
      secondary: {
        main: BRAND_CONFIG.colors.creator.secondary,
        light: BRAND_CONFIG.colors.creator.secondaryLight,
        dark: BRAND_CONFIG.colors.creator.secondaryDark,
        contrastText: '#ffffff',
      },
      background: {
        default: isDark
          ? BRAND_CONFIG.colors.creator.darkBackground
          : BRAND_CONFIG.colors.creator.lightBackground,
        paper: isDark
          ? BRAND_CONFIG.colors.creator.darkSurface
          : BRAND_CONFIG.colors.common.white,
      },
      text: {
        primary: isDark
          ? BRAND_CONFIG.colors.common.neutral50
          : BRAND_CONFIG.colors.common.neutral900,
        secondary: isDark ? '#94a3b8' : '#64748b',
      },
      success: {
        main: THEME_TOKENS.colors.status.success,
        light: '#34d399',
        dark: '#059669',
      },
      warning: {
        main: THEME_TOKENS.colors.status.warning,
        light: '#fbbf24',
        dark: '#d97706',
      },
      error: {
        main: THEME_TOKENS.colors.status.error,
        light: '#f87171',
        dark: '#dc2626',
      },
      info: {
        main: THEME_TOKENS.colors.status.info,
        light: '#60a5fa',
        dark: '#2563eb',
      },
      divider: isDark
