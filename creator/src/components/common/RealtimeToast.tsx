...
import { Snackbar, Alert, AlertColor, Box, Typography, Slide, SlideProps } from '@mui/material';
import { Gift, UserPlus, Star, Radio, Wallet, Bell, Sparkles } from 'lucide-react';
...
export interface ToastMessage {
  ...
  message: string;
  severity: AlertColor;
  iconType?: 'gift' | 'follower' | 'subscriber' | 'room' | 'wallet' | 'notification';
  timestamp?: string;
}
        ...
        {currentToast ? (
          ...
          >
            <Box>
              ...
              <Typography variant="body2" sx={{ fontSize: '0.8125rem', opacity: 0.9, mt: 0.3 }}>
