      ...
      <Toolbar sx={{ justifyContent: 'space-between', px: { xs: 2, sm: 3 }, minHeight: 64 }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
          ...
          <Box sx={{ display: { xs: 'none', sm: 'flex' }, alignItems: 'center', gap: 1 }}>
            <Chip
              icon={<Radio size={14} color={theme.palette.error.main} />}
              label="Studio Gateway Ready"
              variant="outlined"
              size="small"
              sx={{
                fontSize: '0.75rem',
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: { xs: 1, sm: 1.5 } }}>
          ...
          >
            ...
            <Box sx={{ p: 1, borderTop: '1px solid', borderColor: 'divider', textAlign: 'center' }}>
              <Button size="small" fullWidth onClick={() => { handleCloseNotifMenu(); navigate('/creator/notifications'); }}>
          ...
          >
            ...
            <MenuItem onClick={() => handleNavigate('/creator/profile')}>
              <ListItemIcon><User size={18} /></ListItemIcon>
              <ListItemText primary="Creator Profile" />
            </MenuItem>

            <MenuItem onClick={() => handleNavigate('/creator/settings')}>
              <ListItemIcon><Settings size={18} /></ListItemIcon>
              <ListItemText primary="Studio Settings" />
            </MenuItem>

            <MenuItem onClick={() => handleNavigate('/creator/help')}>
