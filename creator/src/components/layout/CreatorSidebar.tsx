...
export const CreatorSidebar: React.FC<CreatorSidebarProps> = ({
  ...
  const navItems: NavItem[] = [
    { label: 'Dashboard', path: '/creator/dashboard', icon: LayoutDashboard, section: 'Core' },
    { label: 'Analytics', path: '/creator/analytics', icon: BarChart3, section: 'Core' },
    { label: 'Live Rooms', path: '/creator/rooms', icon: Radio, badge: 'LIVE', badgeColor: 'error', section: 'Core' },
    { label: 'Schedule', path: '/creator/schedule', icon: Calendar, section: 'Core' },

    { label: 'Audience', path: '/creator/audience', icon: Users, section: 'Community' },
    { label: 'Followers', path: '/creator/followers', icon: UserCheck, section: 'Community' },
    { label: 'Subscribers', path: '/creator/subscribers', icon: Crown, badge: profile.subscribersCount, badgeColor: 'primary', section: 'Community' },

    { label: 'Wallet', path: '/creator/wallet', icon: Wallet, section: 'Monetization' },
    { label: 'Earnings', path: '/creator/earnings', icon: DollarSign, section: 'Monetization' },
    { label: 'Gifts', path: '/creator/gifts', icon: Gift, section: 'Monetization' },
    { label: 'Payout Requests', path: '/creator/payout-requests', icon: CreditCard, section: 'Monetization' },

    { label: 'Notifications', path: '/creator/notifications', icon: Bell, badge: unreadCount > 0 ? unreadCount : undefined, badgeColor: 'error', section: 'Account' },
    { label: 'Profile', path: '/creator/profile', icon: User, section: 'Account' },
    { label: 'Settings', path: '/creator/settings', icon: Settings, section: 'Account' },
    { label: 'Help', path: '/creator/help', icon: HelpCircle, section: 'Support' },
  ];

  const isSelected = (path: string) => {
    if (path === '/creator/dashboard' || path === '/creator') {
      return (
