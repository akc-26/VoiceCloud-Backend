...
import { HelpCircle, ChevronDown, BookOpen, MessageCircle, FileText, Send } from 'lucide-react';
...
export const HelpPage: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Diamonds can be converted anytime once you reach the minimum threshold of 10,000 💎 ($100.00 USD) via the Creator Wallet page.',
    },
    {
    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 2 }}>
        <Box>
          ...
          <Typography variant="body2" color="text.secondary">
            Find answers, broadcasting best practices, creator guidelines, and platform support contacts.
          </Typography>
        </Box>
        <Button
          variant="contained"
      ...
      <Grid container spacing={2.5}>
          ...
          <Card>
            <CardContent sx={{ p: 2.5, textAlign: 'center' }}>
              ...
              <Typography variant="caption" color="text.secondary" sx={{ display: 'block', mb: 2 }}>
                Best practices for audio hosting, engagement, and audience retention.
              </Typography>
        ...
        <Grid xs={12} sm={4}>
          <Card>
            <CardContent sx={{ p: 2.5, textAlign: 'center' }}>
              <HelpCircle size={32} color="#10b981" style={{ marginBottom: 8 }} />
              <Typography variant="h6" sx={{ fontWeight: 700 }}>
                System Version Info
              </Typography>
              <Typography variant="caption" color="text.secondary" sx={{ display: 'block', mb: 2 }}>
                VoiceCloud Enterprise v4.2.0-PH04C | RTC Engine Active.
              </Typography>
      ...
      <Dialog open={isSupportOpen} onClose={() => setIsSupportOpen(false)} maxWidth="sm" fullWidth>
        <DialogTitle sx={{ fontWeight: 800 }}>Contact Creator Support</DialogTitle>
        <DialogContent dividers>
          {supportSubmitted ? (
            <Alert severity="success" sx={{ my: 2 }}>
              Your ticket has been sent! Our support team will reach out to you shortly.
            </Alert>
          ) : (
            <Stack spacing={2.5} sx={{ mt: 1 }}>
              <TextField label="Subject" placeholder="e.g. Question about payout request" fullWidth />
              <TextField
