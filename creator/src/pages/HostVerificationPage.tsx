    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
      ...
      <Box>
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mt: 0.5 }}>
          ...
          unlock high-bitrate streaming, priority discovery, and exclusive
          monetization tiers.
        </Typography>
      </Box>
      ...
      {status === 'APPROVED' && (
        ...
        >
          ...
          Your identity and broadcasting credentials have been verified by{' '}
          {BRAND_CONFIG.identity.name} Compliance. You enjoy verified host
          badges across all audio lounges and room discovery channels.
        </Alert>
      )}
      ...
      {status === 'PENDING' && (
        ...
        >
          ...
          Your host verification application is currently being reviewed by our
          Trust & Safety team. Reviews typically complete within 24 to 48 hours.
        </Alert>
      )}
      ...
      {status === 'SUSPENDED' && (
        ...
        >
          ...
          Your host broadcasting privileges have been suspended. Please contact
          creator support for account audit information.
        </Alert>
      )}
                ...
                <Stack spacing={2}>
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid size={{ xs: 6 }}>
                      ...
                      <Typography variant="body2" sx={{ fontWeight: 600 }}>
                        {hostProfile?.totalRoomsHosted !== undefined
                          ? `${hostProfile.totalRoomsHosted} Lounges`
                          : '0 Lounges'}
                      </Typography>
                    </Grid>
                    <Grid size={{ xs: 6 }}>
                      ...
                      <Typography variant="body2" sx={{ fontWeight: 600 }}>
                        {hostProfile?.peakListeners !== undefined
                          ? hostProfile.peakListeners.toLocaleString()
                          : '0'}
                      </Typography>
                    </Grid>
                  </Grid>
            ...
            <Card>
              <CardContent sx={{ p: 3 }}>
                ...
                <Typography
                  ...
                  sx={{ mb: 3 }}
                >
                  Provide your official identification details and broadcast
                  profile to verify your account.
                </Typography>
                  ...
                  {hostProfile?.idNumber && (
                    ...
                    >
                      <Typography
                        ...
                        sx={{ display: 'block' }}
                      >
                        Current Stored Government ID:{' '}
                        <strong>{hostProfile.idNumber}</strong>
                      </Typography>
                      <Typography variant="caption" color="text.secondary">
                        Leave replacement field below empty to preserve stored
                        ID.
                      </Typography>
                    </Box>
                  )}
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid size={{ xs: 12, sm: 6 }}>
                      <TextField
                        label={
                          hostProfile?.idNumber
                            ? 'New / Replacement Government ID Number'
                        ...
                        helperText={
                          hostProfile?.idNumber
                            ? 'Leave empty to keep current ID'
                            : 'Enter unmasked ID number'
                        }
                        fullWidth
                        size="small"
                        disabled={status === 'PENDING'}
                ...
                <Stack spacing={1.5}>
                  ...
                  >
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                      ...
                      <Box>
                        ...
                        <Typography variant="caption" color="text.secondary">
                          Requires min. {minCompletedRooms} completed voice
                          rooms
                        </Typography>
                      </Box>
                    </Box>
                  ...
                  >
                    ...
                    <Chip
                      ...
                      color={
                        isCommunityStandingEligible ? 'success' : 'warning'
                      }
                      size="small"
                    />
                  </Box>
                ...
                <Stack spacing={1.5}>
                  ...
                  >
                    ...
                    <Typography
                      ...
                      sx={{ display: 'block' }}
                    >
                      Verified Badge, High-Bitrate Ingest, Multi-Mic Audio
                      Lounge
                    </Typography>
                  </Paper>
                  ...
                  <Paper variant="outlined" sx={{ p: 1.5, borderRadius: 2 }}>
                    ...
                    <Typography
                      ...
                      sx={{ display: 'block' }}
                    >
                      Gold Badge, Priority Discovery Placement, Custom Room
                      Frames
                    </Typography>
                  </Paper>
                  ...
                  <Paper variant="outlined" sx={{ p: 1.5, borderRadius: 2 }}>
                    ...
                    <Typography
                      ...
                      sx={{ display: 'block' }}
                    >
                      Diamond Badge, Agency Management Eligibility, Accelerated
                      Payouts
                    </Typography>
                  </Paper>
                </Stack>
