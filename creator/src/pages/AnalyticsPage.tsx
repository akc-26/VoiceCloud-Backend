      ...
      >
        <Box>
          ...
          <Typography variant="body2" color="text.secondary">
            Listener retention, peak concurrent views, subscriber growth, and
          ...
          <Card>
            <CardContent sx={{ p: 2.5 }}>
              ...
              <Typography
                ...
                sx={{ fontWeight: 600 }}
              >
                {data.listenHoursGrowth
                  ? `${data.listenHoursGrowth > 0 ? '+' : ''}${data.listenHoursGrowth}% vs previous period`
                  : 'Not available'}
              </Typography>
            </CardContent>
          </Card>
        ...
        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
          <Card>
            <CardContent sx={{ p: 2.5 }}>
              ...
              <Typography variant="h4" sx={{ fontWeight: 800 }}>
                {data.listenerRetentionRate !== undefined &&
                data.listenerRetentionRate !== null
                  ? `${data.listenerRetentionRate}%`
                  : 'N/A'}
              </Typography>
              <Typography
                variant="caption"
              ...
              >
                {data.avgSessionMinutes
                  ? `${data.avgSessionMinutes} mins avg session`
                  : 'Session retention'}
              </Typography>
            </CardContent>
          </Card>
        ...
        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
          <Card>
            <CardContent sx={{ p: 2.5 }}>
              ...
              >
                {data.revenueGrowth
                  ? `${data.revenueGrowth > 0 ? '+' : ''}${data.revenueGrowth}% Growth`
                  : 'Revenue tracking'}
              </Typography>
            </CardContent>
          </Card>
