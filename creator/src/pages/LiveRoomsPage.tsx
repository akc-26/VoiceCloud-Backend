...
export const LiveRoomsPage: React.FC = () => {
  ...
  const [activeStageRoom, setActiveStageRoom] = useState<LiveRoomSummary | null>(null);
    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 2 }}>
        <Box>
          ...
          <Typography variant="body2" color="text.secondary">
            Manage live broadcasts, speaker stage controls, listener presence, and RTC room configurations.
          </Typography>
        </Box>
        <Button
          variant="contained"
                ...
                <Card sx={{ height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                  <CardContent sx={{ p: 3 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 2 }}>
                      ...
                      />
                      <Chip
                        label={isLive ? '🔴 LIVE' : isPaused ? '⏸ PAUSED' : room.status.toUpperCase()}
                    ...
                    <Grid container spacing={2} sx={{ mb: 2.5 }}>
                      ...
                      <Grid xs={6}>
                        ...
                        <Typography variant="subtitle2" sx={{ fontWeight: 700, display: 'flex', alignItems: 'center', gap: 0.5 }}>
                          <Users size={14} /> {room.currentListeners?.toLocaleString() || 0}
                        </Typography>
                      </Grid>
                    </Grid>
      ...
      >
            ...
            <Box>
              ...
              <Stack spacing={1}>
                ...
                >
                  ...
                  <Chip label="Mic Active" size="small" color="success" icon={<Volume2 size={12} />} />
                </Box>
              </Stack>
            </Box>
          </Stack>
        ...
        <DialogActions sx={{ p: 2 }}>
          <Button onClick={() => setActiveStageRoom(null)}>Close Controls</Button>
        </DialogActions>
      </Dialog>
