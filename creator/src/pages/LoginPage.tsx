...
export const LoginPage: React.FC = () => {
  ...
  const [email, setEmail] = useState('creator@voicecloud.app');
  ...
  const handleSignIn = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setAuth({
        ...
        token: 'mock-jwt-creator-token-vc-ph04a',
      });
      setLoading(false);
        ...
        >
          <CardContent sx={{ p: { xs: 3, sm: 4.5 } }}>
            ...
            {accountCreatedInfo && (
              ...
              >
                Creator registrations are managed by VoiceCloud Administration. Use mock sign-in to test the Creator Studio.
              </Alert>
            )}
