...
export interface ModerationRuleResult {
  ...
  recommendedAction:
    'ALLOW' | 'FLAG_FOR_REVIEW' | 'AUTO_MUTE_USER' | 'AUTO_KICK_USER';
  explanation: string;
}
...
export class AutoModerationService {
  private readonly BLOCKED_PATTERNS = [
    {
      pattern: /\b(scam|phishing|free-coins-click-here|claim-diamonds-now)\b/i,
      category: 'SPAM_PHISHING',
      score: 90,
    },
    {
      pattern: /\b(hate|slur|abuse|harass)\b/i,
      category: 'HATE_SPEECH',
      score: 85,
    },
    {
      pattern: /\b(telegram\.me|t\.me|whatsapp\.com\/chat)\b/i,
