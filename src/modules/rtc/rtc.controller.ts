...
export class RtcController {
  ...
  @UseGuards(JwtAuthGuard)
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Report WebRTC connection metrics (bitrate, packet loss, jitter, RTT)' })
  ...
  @ApiOperation({ summary: 'Get aggregated room WebRTC quality metrics and adaptive recommendations' })
  @ApiParam({ name: 'roomId', description: 'Room ID' })
  ...
  @ApiOperation({ summary: 'Get network score and quality metric for a specific participant' })
  @ApiParam({ name: 'roomId', description: 'Room ID' })
  ...
  // 9. Phase 20 Token Refresh & Pipeline Endpoints
  @Post('token/refresh')
  @UseGuards(JwtAuthGuard)
  @ApiBearerAuth()
  ...
  @ApiOperation({ summary: 'Get current RTC room active participants and presence state' })
  @ApiParam({ name: 'roomId', description: 'Room ID' })
  @ApiResponse({ status: 200, description: 'List of participants and presence' })
