...
export class JoinRoomDto {
  ...
  @ApiPropertyOptional({ description: 'Device information / client identifier' })
  @IsOptional()
  @IsString()
  deviceInfo?: string;
}
...
export class ForceDisconnectDto {
  ...
  @ApiProperty({ description: 'Target user ID to force disconnect', example: 'user-456' })
  @IsString()
  targetUserId: string;

  @ApiPropertyOptional({ description: 'Reason for force disconnect', example: 'Policy violation' })
  @IsOptional()
  @IsString()
  reason?: string;
}
...
export class SpeakingStateDto {
  ...
  @ApiProperty({ description: 'Whether the participant is actively speaking', example: true })
  @IsBoolean()
  isSpeaking: boolean;

  @ApiPropertyOptional({ description: 'Audio input level (0-100)', example: 75 })
  @IsOptional()
  @IsNumber()
  @Min(0)
  @Max(100)
