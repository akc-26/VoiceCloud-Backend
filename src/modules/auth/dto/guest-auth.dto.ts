...
export class GuestUpgradeDto {
  @ApiPropertyOptional({
    description: 'Target link method: phone, google, or email',
    example: 'phone',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: 'Google ID token for Google upgrade',
    example: 'eyJhbGci...',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: 'User email for email upgrade',
  ...
  @ApiPropertyOptional({
    description: 'Password for email upgrade',
...
export class GuestMigrateDto {
  @ApiPropertyOptional({
    description: 'Auth token of target registered account',
    example: 'eyJhbGci...',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: 'Target user ID to merge guest data into',
    example: 'usr_882910',
  })
  @IsOptional()
  @IsString()
