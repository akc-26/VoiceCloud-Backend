...
export class PhoneLoginDto {
  ...
  @ApiPropertyOptional({
    description: 'Firebase Auth ID token (alternative to OTP code)',
    example: 'eyJhbGci...',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: 'Referral code if invited by another user',
    example: 'VC882910',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: 'Unique device fingerprint/ID',
    example: 'dev_pixel7_001',
  })
  @IsOptional()
  @IsString()
  deviceId?: string;
