...
export class GoogleLoginDto {
  @ApiProperty({ description: 'Google Sign In ID Token received from Android/Web client', example: 'eyJhbGci...' })
  @IsString()
  @IsNotEmpty()
  idToken: string;
  ...
  @ApiPropertyOptional({ description: 'Device ID', example: 'dev_galaxy_s23_001' })
  @IsOptional()
  @IsString()
  deviceId?: string;

  @ApiPropertyOptional({ description: 'Device display name', example: 'Samsung Galaxy S23' })
  @IsOptional()
  @IsString()
  deviceName?: string;
