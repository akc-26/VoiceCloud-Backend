...
export class UpdateUserSettingsDto {
  @ApiPropertyOptional({ example: 'everyone', description: 'everyone | following | friends | none' })
  @IsOptional()
  @IsString()
  @IsIn(['everyone', 'following', 'friends', 'none'])
  messagingPermission?: string;

  @ApiPropertyOptional({ example: 'everyone', description: 'everyone | approval | none' })
  @IsOptional()
  @IsString()
  @IsIn(['everyone', 'approval', 'none'])
  followPermission?: string;

  @ApiPropertyOptional({ example: 'everyone', description: 'everyone | friends | none' })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({ example: true, description: 'Allow profile visitors to be logged' })
  @IsOptional()
  @IsBoolean()
  allowVisitorTracking?: boolean;

  @ApiPropertyOptional({ example: false, description: 'Visit other profiles anonymously by default' })
  @IsOptional()
  @IsBoolean()
