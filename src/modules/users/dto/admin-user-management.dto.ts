import { IsString, IsNotEmpty, IsOptional, IsNumber, IsBoolean, IsIn, Min, Max } from 'class-validator';
...
export class AdminAdjustLevelDto {
  ...
  @ApiPropertyOptional({ example: 5000, description: 'Optional experience points override' })
  @IsOptional()
  @IsNumber()
  @Min(0)
  exp?: number;
...
export class CreateBadgeDto {
  @ApiProperty({ example: 'Top-Giver-2026', description: 'Unique badge code identifier' })
  @IsString()
  @IsNotEmpty()
  code: string;
  ...
  @ApiProperty({ example: 'wealth', description: 'wealth | charm | event | vip | creator | system' })
  @IsString()
  @IsNotEmpty()
  category: string;
