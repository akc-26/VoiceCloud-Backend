...
export class SocialIdentityController {
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Get current user personal QR code payload and image' })
  ...
  @Get('public/:username')
  @ApiOperation({ summary: 'Get public profile information by username (No Auth required)' })
