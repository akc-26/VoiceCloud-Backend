...
describe('Phase 17 - Profile, Social Identity & Visitors System Unit Tests', () => {
  ...
  beforeEach(async () => {
    ...
    visitorsService = module.get<ProfileVisitorsService>(
      ProfileVisitorsService,
    );
  ...
  describe('Profile Visitors', () => {
    ...
    it('should record a valid visit', async () => {
      ...
      mockVisitorRepo.create.mockImplementation((data) => ({
        ...data,
        visitedAt: new Date(),
      }));
  ...
  describe('Friends System', () => {
    it('should send a friend request successfully', async () => {
      ...
      mockFriendRequestRepo.create.mockImplementation((data) => ({
        id: 'req-1',
        ...data,
      }));
      mockFriendRequestRepo.save.mockImplementation((data) =>
