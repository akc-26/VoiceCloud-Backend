...
export class UserSettings {
  ...
  @ApiProperty({ description: 'Who can send direct messages (everyone, following, friends, none)' })
  @Column({ type: 'varchar', default: 'everyone' })
  @IsString()
  messagingPermission: string;

  @ApiProperty({ description: 'Who can follow user (everyone, approval, none)' })
  @Column({ type: 'varchar', default: 'everyone' })
  @IsString()
  followPermission: string;

  @ApiProperty({ description: 'Who can invite user to rooms/clubs (everyone, friends, none)' })
  @Column({ type: 'varchar', default: 'everyone' })
  @IsString()
  invitationPermission: string;

  @ApiProperty({ description: 'Who can see profile visitor logs (everyone, friends, none)' })
  @Column({ type: 'varchar', default: 'everyone' })
  @IsString()
