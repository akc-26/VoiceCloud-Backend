...
export class HealthController {
  ...
  @Get('metrics')
  @ApiOperation({ summary: 'Retrieve system operational metrics & resource diagnostics' })
  @ApiResponse({ status: 200, description: 'Operational system metrics retrieved successfully' })
  async getMetrics() {
