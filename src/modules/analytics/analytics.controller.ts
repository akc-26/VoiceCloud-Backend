...
export class AnalyticsController {
  ...
  @ApiOperation({ summary: 'Get audience growth time series for a room session' })
  @ApiParam({ name: 'id', description: 'Room UUID' })
  ...
  @ApiOperation({ summary: 'Get speaker talk time, hand raises and stage activity breakdown' })
  @ApiParam({ name: 'id', description: 'Room UUID' })
  ...
  @ApiOperation({ summary: 'Get hourly chat, poll, quiz, and reaction engagement metrics' })
  @ApiParam({ name: 'id', description: 'Room UUID' })
