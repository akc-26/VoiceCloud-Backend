...
describe('Phase 2D Creator Economy Business APIs', () => {
  ...
  const mockStreamCredentialRepository = {
    findOne: jest.fn(),
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        ...
        {
          provide: getRepositoryToken(CreatorStreamCredential),
          useValue: mockStreamCredentialRepository,
        },
        {
          provide: getRepositoryToken(StreamKeyAuditLog),
