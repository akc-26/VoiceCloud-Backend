...
export class RankingsController {
  ...
  // 3. AGENCY RANKINGS
  @Get(['leaderboards/agencies', 'rankings/leaderboard/agencies'])
  @Public()
  @ApiOperation({
    summary:
      'Get Agency Leaderboard by revenue, active hosts, online hosts, growth, engagement, total gifts',
  })
  ...
  @Get(['trending/agencies', 'rankings/trending/agencies'])
  @Public()
