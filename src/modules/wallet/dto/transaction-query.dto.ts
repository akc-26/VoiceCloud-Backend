...
export class TransactionQueryDto {
  ...
  @ApiPropertyOptional({ enum: WalletCurrency, description: 'Filter by currency' })
  @IsOptional()
  @IsEnum(WalletCurrency)
  currency?: WalletCurrency;

  @ApiPropertyOptional({ description: 'Sort order by creation time', enum: ['ASC', 'DESC'], default: 'DESC' })
  @IsOptional()
  @IsString()
