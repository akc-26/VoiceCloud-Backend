...
import { IsUUID, IsEnum, IsNumber, IsOptional, IsString, IsObject } from 'class-validator';
...
export class WalletTransaction {
  ...
  @ApiProperty({ enum: WalletTransactionType, default: WalletTransactionType.PURCHASE })
  ...
  @ApiPropertyOptional({ description: 'Type of entity or source referenced (e.g. COIN_PACKAGE, GIFT)' })
  ...
  @ApiProperty({ enum: WalletTransactionStatus, default: WalletTransactionStatus.COMPLETED })
  ...
  @ApiPropertyOptional({ description: 'Human readable transaction description' })
  ...
  @ManyToOne(() => WalletBalance, (wb) => wb.transactions, { onDelete: 'CASCADE' })
