...
export class WalletController {
  ...
  @Get('summary')
  @ApiOperation({ summary: 'Get wallet summary overview, latest transaction and stats' })
  ...
  @ApiResponse({ status: 200, description: 'Active coin packages retrieved successfully' })
  async getPackages() {
  ...
  @ApiOperation({ summary: 'Generate purchase preview for a coin package without charge' })
  @ApiResponse({ status: 200, description: 'Purchase preview generated successfully' })
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Generate diamond to coin conversion preview without wallet deduction' })
  @ApiResponse({ status: 200, description: 'Conversion preview generated successfully' })
