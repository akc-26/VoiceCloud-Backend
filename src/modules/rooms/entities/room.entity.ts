...
import { IsString, IsOptional, IsBoolean, IsInt, IsUUID, IsNumber } from 'class-validator';
...
export class Room {
  ...
  // Relationships
  @ManyToOne(() => Club, (club) => club.rooms, { onDelete: 'SET NULL', nullable: true })
  @JoinColumn({ name: 'clubId' })
  club: Club;

  @OneToOne(() => ScheduledRoom, (sr) => sr.liveRoom, { onDelete: 'SET NULL', nullable: true })
