...
@Module({
  ...
  controllers: [RoomTicketsController, ScheduledRoomsController, SoundboardController, RoomsController],
  providers: [RoomsService, ScheduledRoomsService, RoomTicketsService, SoundboardService],
  exports: [RoomsService, ScheduledRoomsService, RoomTicketsService, SoundboardService, TypeOrmModule],
})
