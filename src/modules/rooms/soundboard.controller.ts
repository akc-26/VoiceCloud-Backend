...
export class SoundboardController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Preset sound effects list retrieved successfully',
  })
  getPresets() {
    return {
      success: true,
  ...
  @ApiResponse({
    status: 200,
    description: 'Sound effect triggered successfully',
  })
  @ApiResponse({
    status: 403,
    description: 'User is not authorized (host or co-host required)',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Room audio state retrieved successfully',
  })
  @ApiResponse({ status: 404, description: 'Room not found' })
