...
export class UpdateScheduledRoomDto extends PartialType(CreateScheduledRoomDto) {
  @ApiPropertyOptional({ enum: ScheduledRoomStatus, description: 'Scheduled room status' })
  @IsOptional()
