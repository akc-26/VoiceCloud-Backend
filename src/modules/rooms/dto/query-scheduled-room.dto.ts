...
import { IsOptional, IsString, IsEnum, IsInt, IsBoolean, IsUUID, Min, Max } from 'class-validator';
import { Type } from 'class-transformer';
import { ScheduledRoomStatus, VisibilityType } from '../../../common/enums';

export class QueryScheduledRoomDto {
  @ApiPropertyOptional({ description: 'Search term for room title or description' })
  @IsOptional()
  @IsString()
  search?: string;
  ...
  @ApiPropertyOptional({ enum: ScheduledRoomStatus, description: 'Filter by status' })
  @IsOptional()
