...
describe('SoundboardService', () => {
  ...
  describe('triggerSoundEffect', () => {
    it('should throw NotFoundException if room does not exist', async () => {
      ...
      await expect(
        service.triggerSoundEffect('room-999', 'user-1', { category: SoundEffectCategory.APPLAUSE }),
    ...
    it('should throw ForbiddenException if user is not host or cohost', async () => {
      ...
      await expect(
        service.triggerSoundEffect('room-123', 'unauthorized-user', { category: SoundEffectCategory.APPLAUSE }),
