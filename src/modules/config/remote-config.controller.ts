...
export class RemoteConfigController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Remote config retrieved successfully.',
  })
  ...
  @ApiOperation({
    summary: 'Check mobile application version update requirements',
  })
  @ApiQuery({ name: 'platform', required: false, example: 'android' })
  @ApiQuery({ name: 'currentVersion', required: false, example: '1.0.0' })
  @ApiResponse({
    status: 200,
    description: 'Version check result returned successfully.',
  })
