...
export class SendGiftDto {
  ...
  @ApiPropertyOptional({ description: 'Room ID (required if context is room or event)' })
  @IsOptional()
  @IsString()
  roomId?: string;
  ...
  @ApiPropertyOptional({ description: 'Combo count override / sequence step', example: 1 })
  @IsOptional()
  @IsNumber()
  @Min(1)
  comboStep?: number = 1;
