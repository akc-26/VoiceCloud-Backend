...
export class CreateDynamicGiftDto {
  ...
  @ApiPropertyOptional({
    description: 'Gift Type (static, animated, svga, lottie, video, premium, limited, seasonal, country_specific, hidden)',
    example: 'svga',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({ description: 'Creator Earnings Percentage', example: 70.0 })
  @IsOptional()
  @IsNumber()
  @Min(0)
  @Max(100)
  ...
  @ApiPropertyOptional({ description: 'Agency Earnings Percentage', example: 10.0 })
  @IsOptional()
  @IsNumber()
  @Min(0)
  @Max(100)
  agencyEarningsPercentage?: number = 10.0;
  ...
  @ApiPropertyOptional({ description: 'Is Gift Hidden from general catalog', default: false })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({ description: 'Display / Sort order in catalog', example: 0 })
  @IsOptional()
  @IsNumber()
  sortOrder?: number = 0;
