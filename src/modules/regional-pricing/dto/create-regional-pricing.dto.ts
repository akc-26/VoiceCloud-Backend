...
export class CreateRegionalPricingDto {
  ...
  @ApiPropertyOptional({ description: 'Local tax percentage (e.g., 18 for 18%)', example: 18 })
  @IsOptional()
  @IsNumber()
  @Min(0)
  @Max(100)
  ...
  @ApiPropertyOptional({ description: 'Is active for regional users', example: true })
  @IsOptional()
  @IsBoolean()
