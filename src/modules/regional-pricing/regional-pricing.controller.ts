...
export class RegionalPricingController {
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: 'Create or update regional country pricing configuration (Admin)',
  })
  ...
  @Get('countries')
  @ApiOperation({
    summary: 'Get list of all regional country pricing configurations',
  })
  @ApiResponse({
    status: 200,
    description: 'List of country pricing configurations',
  })
  async getAllConfigs() {
  ...
  @Post('convert')
  @ApiOperation({
    summary: 'Convert coin prices into localized currency prices with taxes',
  })
  ...
  @ApiOperation({
    summary: 'Calculate localized creator earnings and platform fees',
  })
  @ApiResponse({
    status: 200,
    description: 'Creator localized earnings breakdown',
  })
