...
export class BackupController {
  ...
  @Post('restore')
  @ApiOperation({
    summary: 'Execute platform restoration with auto-rollback protection',
  })
  async restoreBackup(
  ...
  @ApiOperation({
    summary: 'Enforce retention policies and purge expired backups',
  })
  ...
  @ApiOperation({
    summary: 'Get Disaster Recovery health status & RPO/RTO metrics',
  })
