...
@ApiTags('Referral & Invite System')
...
export class ReferralController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Referral code generated or updated',
  })
  async generateCode(
    @Request() req: any,
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: 'Get user referral summary, stats, and next milestone',
  })
  ...
  @ApiBearerAuth()
  @ApiOperation({
    summary: 'Get history of referred users and qualification status',
  })
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({
    summary: 'Apply a referrer code during registration or onboarding',
  })
  @ApiResponse({
    status: 200,
