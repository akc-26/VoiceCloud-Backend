...
export class AdminReferralController {
  ...
  @ApiOperation({ summary: 'Execute fraud action (Approve, Reject, Blacklist, Suspend, Restore)' })
  ...
  @Post('blacklist')
  @ApiOperation({ summary: 'Add IP, Device ID, or User ID to referral blacklist' })
  ...
  @Post('approve')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Manually approve a pending/suspected referral relationship' })
