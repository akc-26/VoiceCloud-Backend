...
export class CreateReferralCampaignDto {
  @ApiProperty({
    ...
    example: 'Summer Referral Festival',
  })
  @IsNotEmpty()
  @IsString()
  campaignName: string;
  ...
  @ApiPropertyOptional({
    ...
    example: 'Invite friends and win exclusive frames!',
  })
  @IsOptional()
  @IsString()
  description?: string;
  ...
  @ApiProperty({
    description: 'Campaign Start Date (ISO)',
  ...
  @ApiProperty({
    description: 'Campaign End Date (ISO)',
  ...
  @ApiPropertyOptional({
    description: 'Country restrictions (e.g. ["US", "IN"])',
    example: ['US', 'IN'],
  })
  @IsOptional()
  @IsArray()
  ...
  @ApiPropertyOptional({
    description: 'Daily limit per user (0 = unlimited)',
    default: 0,
  })
  @IsOptional()
  @IsInt()
  ...
  @ApiPropertyOptional({
    description: 'Global campaign limit (0 = unlimited)',
    default: 0,
  })
  @IsOptional()
  @IsInt()
