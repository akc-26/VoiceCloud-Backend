...
export class CreateRewardConfigDto {
  ...
  @ApiProperty({ description: 'Reward amount (coins, diamonds, XP, VIP days)', example: 100 })
  @IsInt()
  @Min(1)
  amount: number;

  @ApiPropertyOptional({ description: 'Item ID (for store items, frames, bubbles, effects)' })
  @IsOptional()
  @IsString()
  itemId?: string;
  ...
  @ApiPropertyOptional({ description: 'Reward recipient target: REFERRER, REFERRED, or BOTH', example: 'REFERRER' })
  @IsOptional()
  @IsString()
  target?: string;
}
