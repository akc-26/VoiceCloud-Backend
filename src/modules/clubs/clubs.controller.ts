...
export class ClubsController {
  ...
  @ApiResponse({
    status: 400,
    description: 'Club owner cannot leave without transferring or deleting.',
  })
  ...
  @Get(':id/scheduled-rooms')
  @Public()
  @ApiOperation({ summary: 'Get scheduled rooms associated with a club' })
  ...
  @ApiResponse({ status: 404, description: 'Club not found.' })
  async getScheduledRooms(@Param('id') id: string) {
    return this.clubsService.getScheduledRooms(id);
  }
}
