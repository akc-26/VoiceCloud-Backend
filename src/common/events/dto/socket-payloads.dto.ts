...
export enum RoomStageLayout {
  GRID = 'GRID',
  SPOTLIGHT = 'SPOTLIGHT',
}

export class MuteAllSpeakersDto extends RoomEventBaseDto {}

export class ChangeStageLayoutDto extends RoomEventBaseDto {
  @IsEnum(RoomStageLayout)
  layout: RoomStageLayout;
}

export class PinRoomMessageDto extends RoomEventBaseDto {
  @IsOptional()
  @IsString()
  messageId?: string;
