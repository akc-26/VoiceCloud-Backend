export const QUEUE_NAMES = {
  ...
  AGENCY_SETTLEMENT: 'agency-settlement-queue',
  AGENCY_ANALYTICS: 'agency-analytics-queue',
  AGENCY_REWARDS: 'agency-rewards-queue',
  AGENCY_VERIFICATION: 'agency-verification-queue',
  TASKS: 'tasks-queue',
  STORE: 'store-queue',
} as const;
...
export const JOB_TYPES = {
  ...
  AGENCY: {
    SETTLEMENT_CALCULATE: 'agency-settlement-calculate',
    ANALYTICS_REFRESH: 'agency-analytics-refresh',
    REWARD_DISTRIBUTE: 'agency-reward-distribute',
    VERIFICATION_PROCESS: 'agency-verification-process',
  },
  RANKINGS: {
