...
export const AppVersionsPage: React.FC = () => {
  ...
  const columns: Column<AppVersion>[] = [
    {
      ...
      render: (row) => (
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          <Typography variant="body2" sx={{ fontWeight: 700 }}>{row.versionName} ({row.platform})</Typography>
        </Box>
      ),
    },
  ...
  return (
    <Box>
      <Box sx={{ mb: 3 }}>
        <Typography variant="h4" sx={{ fontWeight: 800 }}>App Version Control & Over-The-Air</Typography>
