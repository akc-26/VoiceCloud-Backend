  ...
  const [pages, setPages] = useState<CmsPageItem[]>([
    {
      ...
      content: `## ${BRAND_CONFIG.identity.name} Terms of Service\nWelcome to ${BRAND_CONFIG.identity.name}...`,
      status: 'published',
    ...
    <Box>
      <Box sx={{ mb: 3 }}>
        ...
        <Typography variant="body2" color="text.secondary">
          Manage legal documents, terms of service, help desk articles, and FAQ
          pages
        </Typography>
      </Box>
