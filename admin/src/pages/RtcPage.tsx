...
export const RtcPage: React.FC = () => {
  ...
  return (
    <Box>
      <Box sx={{ mb: 3 }}>
        <Typography variant="h4" fontWeight={800}>RTC Voice Infrastructure</Typography>
          ...
          <Card elevation={0} sx={{ border: activeProvider === 'agora' ? '2px solid #1d4ed8' : '1px solid #e2e8f0' }}>
            <CardContent>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 2 }}>
                ...
                <Typography variant="h6" fontWeight={700}>Agora RTC Engine</Typography>
              </Box>
          ...
          <Card elevation={0} sx={{ border: activeProvider === 'livekit' ? '2px solid #1d4ed8' : '1px solid #e2e8f0' }}>
            <CardContent>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 2 }}>
                ...
                <Typography variant="h6" fontWeight={700}>LiveKit SFU Server</Typography>
              </Box>
              <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
          ...
          <Card elevation={0} sx={{ border: activeProvider === 'zegocloud' ? '2px solid #1d4ed8' : '1px solid #e2e8f0' }}>
            <CardContent>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 2 }}>
                ...
                <Typography variant="h6" fontWeight={700}>ZegoCloud Voice</Typography>
              </Box>
              <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
