    ...
    <Box sx={{ p: 1 }}>
      ...
      {drStatus && (
        <Grid container spacing={2} sx={{ mb: 3 }}>
          <Grid size={{ xs: 12, sm: 6, md: 3 }}>
            <Paper elevation={0} sx={{ p: 2, border: '1px solid', borderColor: 'divider', borderRadius: 2 }}>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <Typography variant="caption" color="text.secondary" sx={{ fontWeight: 700 }}>DR READINESS SCORE</Typography>
                <Chip label={drStatus.status} color={drStatus.status === 'EXCELLENT' ? 'success' : 'warning'} size="small" />
              </Box>
              <Typography variant="h4" sx={{ mt: 0.5, fontWeight: 800 }} color="primary.main">
          ...
          <Grid size={{ xs: 12, sm: 6, md: 3 }}>
            <Paper elevation={0} sx={{ p: 2, border: '1px solid', borderColor: 'divider', borderRadius: 2 }}>
              <Typography variant="caption" color="text.secondary" sx={{ fontWeight: 700 }}>RECOVERY POINT (RPO)</Typography>
          ...
          <Grid size={{ xs: 12, sm: 6, md: 3 }}>
            <Paper elevation={0} sx={{ p: 2, border: '1px solid', borderColor: 'divider', borderRadius: 2 }}>
              <Typography variant="caption" color="text.secondary" sx={{ fontWeight: 700 }}>EST. RECOVERY TIME (RTO)</Typography>
              <Typography variant="h4" sx={{ mt: 0.5, fontWeight: 800 }} color="info.main">
          ...
          <Grid size={{ xs: 12, sm: 6, md: 3 }}>
            <Paper elevation={0} sx={{ p: 2, border: '1px solid', borderColor: 'divider', borderRadius: 2 }}>
              <Typography variant="caption" color="text.secondary" sx={{ fontWeight: 700 }}>HARDWARE / PI DRIVE</Typography>
              ...
              <Table size="small">
                ...
                <TableBody>
                  {backups.map((b) => (
                    <TableRow key={b.id}>
                      <TableCell>
                        <Typography variant="subtitle2" sx={{ fontWeight: 800 }}>{b.name}</Typography>
                      ...
                      <TableCell>
                        <Typography variant="body2" sx={{ fontWeight: 600 }}>{formatBytes(b.fileSizeCompressed)}</Typography>
              ...
              <Table size="small">
                ...
                <TableBody>
                  {restoreHistory.map((r) => (
                    <TableRow key={r.id}>
                      <TableCell>
                        <Typography variant="body2" sx={{ fontWeight: 700 }}>{r.id}</Typography>
        ...
        {activeTab === 2 && (
          <Box sx={{ p: 2 }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 2 }}>
              <Typography variant="subtitle1" sx={{ fontWeight: 800 }}>Automated Backup Schedule Policies</Typography>
                ...
                <Grid size={{ xs: 12, md: 6 }} key={idx}>
                  <Paper elevation={0} sx={{ p: 2, border: '1px solid', borderColor: 'divider', borderRadius: 2 }}>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1 }}>
                      <Typography variant="subtitle2" sx={{ fontWeight: 800 }}>{sc.scenario}</Typography>
      ...
      <Dialog open={createBackupOpen} onClose={() => setCreateBackupOpen(false)} maxWidth="sm" fullWidth>
        <DialogTitle sx={{ fontWeight: 800 }}>Create Manual / Emergency Backup</DialogTitle>
      ...
      <Dialog open={restoreModalOpen} onClose={() => setRestoreModalOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle sx={{ fontWeight: 800 }}>Restore Platform Snapshot</DialogTitle>
        <DialogContent dividers>
            ...
            <Box sx={{ py: 1 }}>
              ...
              {restorePreview ? (
                <Paper elevation={0} sx={{ p: 2, bgcolor: 'action.hover', mb: 2 }}>
                  <Typography variant="subtitle2" sx={{ fontWeight: 800 }}>RESTORE PREVIEW METRICS:</Typography>
      ...
      <Dialog open={scheduleModalOpen} onClose={() => setScheduleModalOpen(false)} maxWidth="sm" fullWidth>
        <DialogTitle sx={{ fontWeight: 800 }}>Create Backup Schedule Policy</DialogTitle>
        <DialogContent dividers>
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, pt: 1 }}>
            <TextField
              fullWidth
