    ...
    <Box>
      ...
      {activeTab === 1 && (
        <Box>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 3 }}>
            <Typography variant="h6" fontWeight={700}>Badges Catalog</Typography>
      ...
      {activeTab === 2 && (
        <Box>
              ...
              <Grid item xs={12} sm={4}>
                <Card variant="outlined">
                  <CardContent>
                    ...
                    <Typography variant="h4" fontWeight={800}>{visitorStats.totalVisits || 0}</Typography>
                  </CardContent>
                </Card>
              </Grid>
              <Grid item xs={12} sm={4}>
                <Card variant="outlined">
                  <CardContent>
                    ...
                    <Typography variant="h4" fontWeight={800}>{visitorStats.totalVisitorRecords || 0}</Typography>
                  </CardContent>
                </Card>
              </Grid>
              <Grid item xs={12} sm={4}>
                <Card variant="outlined">
                  <CardContent>
                    ...
                    <Typography variant="h4" fontWeight={800}>{visitorStats.anonymousVisits || 0}</Typography>
                  </CardContent>
                </Card>
              </Grid>
            </Grid>
          ...
          <Typography variant="h6" fontWeight={700} sx={{ mb: 2 }}>Profile Visitor Logs</Typography>
          <DataTable
            columns={[
        ...
        {selectedUser && (
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
            ...
            <Box sx={{ p: 2, bgcolor: 'action.hover', borderRadius: 2 }}>
              <Typography variant="subtitle2" fontWeight={700} sx={{ mb: 1 }}>Wealth & Charm Controls</Typography>
            ...
            <Box sx={{ p: 2, bgcolor: 'action.hover', borderRadius: 2 }}>
              <Typography variant="subtitle2" fontWeight={700} sx={{ mb: 1 }}>Badge Assignment</Typography>
            ...
            {userSettings && (
              <Box sx={{ p: 2, bgcolor: 'action.hover', borderRadius: 2 }}>
                <Typography variant="subtitle2" fontWeight={700} sx={{ mb: 1 }}>Privacy & Visitor Settings</Typography>
                <FormControlLabel
                  control={
                    <Switch
