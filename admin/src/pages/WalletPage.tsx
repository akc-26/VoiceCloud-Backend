...
export const WalletPage: React.FC = () => {
  ...
  const columns: Column<Transaction>[] = [
    ...
    { id: 'type', label: 'Transaction Type' },
    {
      ...
      label: 'Amount',
      render: (row) => (
        <Typography variant="body2" sx={{ fontWeight: 700 }} color={row.amount > 0 ? 'success.main' : 'error.main'}>
        ...
        <Grid size={{ xs: 12, sm: 6, md: 4 }}>
          <Card elevation={0}>
            <CardContent>
              ...
              <Typography variant="h4" sx={{ fontWeight: 800 }} color="primary.main">$248,500.00</Typography>
            </CardContent>
          </Card>
        </Grid>
        <Grid size={{ xs: 12, sm: 6, md: 4 }}>
          <Card elevation={0}>
            <CardContent>
              ...
              <Typography variant="h4" sx={{ fontWeight: 800 }} color="warning.main">$12,450.00</Typography>
            </CardContent>
          </Card>
        </Grid>
        <Grid size={{ xs: 12, sm: 6, md: 4 }}>
          <Card elevation={0}>
            <CardContent>
              ...
              <Typography variant="h4" sx={{ fontWeight: 800 }} color="success.main">1,480,000 Coins</Typography>
            </CardContent>
          </Card>
        </Grid>
      </Grid>
