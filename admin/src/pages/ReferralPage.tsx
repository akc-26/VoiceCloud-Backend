...
export const ReferralPage: React.FC = () => {
  ...
  const [fraudLogs, setFraudLogs] = useState([
    ...
    },
    {
      ...
      triggerReason:
        'Excessive referral rate velocity (12 referrals in last hour)',
      riskScore: 60,
      status: 'SUSPECTED',
      ipAddress: '10.0.0.12',
  ...
  const [blacklist, setBlacklist] = useState([
    {
      ...
      type: 'IP',
      value: '192.168.1.100',
      reason: 'Botnet IP Address',
      createdAt: '2026-07-20',
    },
    {
      id: 'bl-2',
      type: 'DEVICE',
      value: 'device-id-spammer-99',
      reason: 'Multiple account generation',
  ...
  const handleApproveFraud = (id: string) => {
    setFraudLogs(
      fraudLogs.map((f) => (f.id === id ? { ...f, status: 'CLEAN' } : f)),
    );
  };

  const handleRejectFraud = (id: string) => {
    setFraudLogs(
      fraudLogs.map((f) => (f.id === id ? { ...f, status: 'CONFIRMED' } : f)),
    );
  };
    ...
    <Box sx={{ p: 3 }}>
      ...
      >
        <Box>
          ...
          >
            <ShareIcon fontSize="large" /> Referral & Invite System
          </Typography>
          <Typography variant="body2" color="text.secondary">
            Manage referral campaigns, invite tracking, milestone rewards,
            anti-fraud controls & real-time analytics.
          </Typography>
        </Box>
        ...
        <Grid size={{ xs: 12, sm: 6, md: 2.4 }}>
          <Card elevation={2} sx={{ borderRadius: 3 }}>
            <CardContent>
              ...
              <Typography
                variant="h4"
                sx={{ fontWeight: 800, my: 0.5, color: 'success.main' }}
              >
                1,050
              </Typography>
        ...
        <Grid size={{ xs: 12, sm: 6, md: 2.4 }}>
          <Card elevation={2} sx={{ borderRadius: 3 }}>
            <CardContent>
              ...
              <Typography
                variant="h4"
                sx={{ fontWeight: 800, my: 0.5, color: 'warning.main' }}
              >
                185
              </Typography>
              <Typography variant="caption" color="text.secondary">
        ...
        <Grid size={{ xs: 12, sm: 6, md: 2.4 }}>
          <Card elevation={2} sx={{ borderRadius: 3 }}>
            <CardContent>
              ...
              <Typography
                variant="h4"
                sx={{ fontWeight: 800, my: 0.5, color: 'primary.main' }}
              >
                245,000
              </Typography>
              <Typography variant="caption" color="text.secondary">
        ...
        <Grid size={{ xs: 12, sm: 6, md: 2.4 }}>
          <Card elevation={2} sx={{ borderRadius: 3 }}>
            <CardContent>
              ...
              <Typography
                variant="h4"
                sx={{ fontWeight: 800, my: 0.5, color: 'error.main' }}
              >
                45
              </Typography>
              <Typography
      ...
      <Paper elevation={1} sx={{ borderRadius: 3, mb: 3 }}>
        ...
        >
          ...
          <Tab
            icon={<SecurityIcon />}
            iconPosition="start"
            label="Fraud & Blacklist Engine"
          />
          <Tab
            icon={<EmojiEventsIcon />}
            iconPosition="start"
            label="Milestones & Grant Rewards"
          />
          <Tab
            icon={<AssessmentIcon />}
            iconPosition="start"
                      ...
                      <TableCell>
                        <Tooltip title="Approve Referral">
                          <IconButton
                            color="success"
                            size="small"
                            onClick={() => handleApproveFraud(log.id)}
                          >
                            <CheckCircleIcon />
                          </IconButton>
                        </Tooltip>
                        <Tooltip title="Reject & Mark Fraud">
                          <IconButton
                            color="error"
                            size="small"
                            onClick={() => handleRejectFraud(log.id)}
                          >
                            <CancelIcon />
                          </IconButton>
                        </Tooltip>
          ...
          <Box sx={{ p: 3 }}>
            ...
            >
              ...
              <Button
                variant="contained"
                color="primary"
                onClick={() => setOpenGrantRewardDialog(true)}
              >
                Manual Grant Reward
              </Button>
            </Box>
        ...
        <DialogContent>
          ...
          <FormControl fullWidth margin="normal">
            ...
            <Select
              ...
              label="Reward Type"
              onChange={(e) =>
                setNewCampaign({ ...newCampaign, rewardType: e.target.value })
              }
            >
          ...
          <TextField
            ...
            onChange={(e) =>
              setNewCampaign({ ...newCampaign, amount: Number(e.target.value) })
            }
            margin="normal"
          />
        </DialogContent>
        ...
        <DialogContent>
          <FormControl fullWidth margin="normal">
            ...
            <Select
              ...
              label="Type"
              onChange={(e) =>
                setNewBlacklist({ ...newBlacklist, type: e.target.value })
              }
            >
          ...
          <TextField
            ...
            value={newBlacklist.value}
            onChange={(e) =>
              setNewBlacklist({ ...newBlacklist, value: e.target.value })
            }
            margin="normal"
      ...
      {/* GRANT REWARD DIALOG */}
      <Dialog
        open={openGrantRewardDialog}
        onClose={() => setOpenGrantRewardDialog(false)}
        maxWidth="sm"
        fullWidth
      >
        ...
        <DialogContent>
          <TextField
            ...
            onChange={(e) =>
              setGrantRewardForm({ ...grantRewardForm, userId: e.target.value })
            }
            margin="normal"
          />
          <FormControl fullWidth margin="normal">
        ...
        <DialogActions sx={{ p: 2.5 }}>
          <Button onClick={() => setOpenGrantRewardDialog(false)}>
            Cancel
          </Button>
          <Button
            variant="contained"
