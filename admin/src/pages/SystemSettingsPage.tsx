...
export const SystemSettingsPage: React.FC = () => {
  ...
  return (
    <Box>
      <Box sx={{ mb: 3 }}>
        <Typography variant="h4" sx={{ fontWeight: 800 }}>Global System Settings</Typography>
          ...
          <Grid container spacing={3}>
            <Grid size={12}>
              <FormControlLabel
                ...
                label={
                  <Box>
                    <Typography variant="subtitle1" sx={{ fontWeight: 700 }}>Emergency Maintenance Mode</Typography>
