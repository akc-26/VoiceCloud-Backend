            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <Card sx={{ borderRadius: 3, boxShadow: 2 }}>
                <CardContent>
                  ...
                  <Typography variant="h3" color="primary.main" sx={{ my: 1, fontWeight: 800 }}>
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <Card sx={{ borderRadius: 3, boxShadow: 2 }}>
                <CardContent>
                  ...
                  <Typography variant="h3" color="secondary.main" sx={{ my: 1, fontWeight: 800 }}>
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <Card sx={{ borderRadius: 3, boxShadow: 2 }}>
                <CardContent>
                  ...
                  <Typography variant="h3" color="error.main" sx={{ my: 1, fontWeight: 800 }}>
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3 }}>
              <Card sx={{ borderRadius: 3, boxShadow: 2 }}>
                <CardContent>
                  ...
                  <Typography variant="h3" color="success.main" sx={{ my: 1, fontWeight: 800 }}>
          ...
          <TableContainer>
            <Table>
              <TableHead sx={{ backgroundColor: 'action.hover' }}>
                <TableRow>
                  <TableCell sx={{ fontWeight: 700 }}>ID / Name</TableCell>
                ...
                {attachmentsLoading ? (
                  ...
                  attachmentsData?.attachments?.map((att: any, idx: number) => (
                    <TableRow key={idx} hover>
                      <TableCell>
                        <Typography variant="body2" noWrap sx={{ fontWeight: 600, maxWidth: 300 }}>
                          {att.name || att.url}
                        </Typography>
                      </TableCell>
                      <TableCell>
